...
util.getProjzh = function() {
    ...
    datum.gcj02.toWGS84 = forEachPoint(function(input, output, offset) {
    ...
    datum.gcj02.fromWGS84 = forEachPoint(function(input, output, offset) {
        var lng = input[offset];
        var lat = input[offset + 1];
        if (!outOfChina(lng, lat)) {
            var deltaD = delta(lng, lat);
    ...
    var toGCJ02 = forEachPoint(function(input, output, offset) {
    ...
    var fromGCJ02 = forEachPoint(function(input, output, offset) {
        var x = input[offset];
    ...
    datum.bd09.toWGS84 = function(input, opt_output, opt_dimension) {
        var output = toGCJ02(input, opt_output, opt_dimension);
        return datum.gcj02.toWGS84(output, output, opt_dimension);
    };

    datum.bd09.fromWGS84 = function(input, opt_output, opt_dimension) {
    ...
    projection.baiduMercator.forward = forEachPoint(function(input, output, offset) {
    ...
    projection.baiduMercator.inverse = forEachPoint(function(input, output, offset) {
    ...
    projection.sphericalMercator.forward = forEachPoint(function(input, output, offset) {
    ...
    projection.sphericalMercator.inverse = forEachPoint(function(input, output, offset) {
    ...
    return {
        ...
        ll2smerc: projection.sphericalMercator.forward,

        smerc2ll: projection.sphericalMercator.inverse
    }
